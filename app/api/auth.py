...
from app.exceptions import EmailException, EmailHTTPException, EmailPasswordValidationException, EmailPasswordValidationHTTPException, UserEmailNotFoundException, UserEmailNotFoundHTTPException
...
@auth_router.get("/me", summary="Информация о пользователе", description="<h1>Получение данных активного пользователя</h1>")
